...
import 'package:finance_tracker_app/screens/add_expense/blocs/create_expense_bloc/create_expense_bloc.dart';
                          ...
                          decoration: InputDecoration(
                            ...
                            prefix: const Padding(
                              padding: EdgeInsets.only(
                                  right: 8.0), // Optional padding for spacing
                              child: Text(
                                'Ksh',
                                style: TextStyle(
                                  color: Color.fromARGB(255, 0, 0,
                                      0), // Customize the prefix color if desired
                                  fontSize:
                                      16, // Customize the prefix font size
                                ),
                              ),
                            ),
